...
export default function ModelSidebar({ isOpen, toggleSidebar }: ModelSidebarProps) {
  ...
  const handleTestModel = async () => {
    ...
    try {
      ...
      if (data.success) {
        console.log("Model test successful. Response:", data.response);
            ...
            <div className="p-4 pb-20">
                  ...
                  <div className="mb-2">
                    <p
                      className={`text-sm italic transition-colors duration-200 ${
                        isConfigHovered ? "text-[#d1a35c]" : "text-[#8a8a8a]"
                      }`}
                    >
                          ...
                          {editingConfigId === config.id ? (
                            ...
                            <>
                              ...
                              {showEditHint && configs.length > 1 && (
                                <span
                                  className={`absolute ${
                                    idx === 0 ? "top-full mt-1" : "-top-8"
                                  } left-0 z-[9999] bg-[#2a2522] text-[#d1a35c] text-xs px-2 py-1 rounded border border-[#d1a35c] whitespace-nowrap opacity-0 group-hover/name:opacity-100 transition-all duration-200 pointer-events-none shadow-[0_0_8px_rgba(209,163,92,0.2)]`}
                                >
                ...
                <div className="mb-6">
                  ...
                  <div className="mb-6">
                    ...
                    <input
                      ...
                      className="bg-[#292929] border border-[#534741] rounded w-full py-3 px-3 text-sm text-[#d0d0d0] leading-tight focus:outline-none focus:border-[#d1a35c] transition-colors"
                      placeholder={
                        llmType === "openai" ? "gpt-4-turbo, claude-3-opus-20240229..." : "llama3, mistral, mixtral..."
                      }
                      value={model}
                    ...
                    {llmType === "openai" && (
                      <div className="mt-3 text-sm text-[#8a8a8a]">
                        ...
                        >
                          ...
                          {openaiModelList.map((option) => (
                            <option key={option} value={option} className="bg-[#292929] text-[#d0d0d0]">
                              {option}
                            </option>
                          ))}
                        </select>
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      onClick={() => {
                        trackButtonClick("cancel_create_config_btn", "取消创建配置");
                        handleCancelCreate();
                      }}
              ...
              {configs.length === 0 && !showNewConfigForm && (
                <div className="flex flex-col items-center justify-center py-8">
                  <p className="text-sm text-[#8a8a8a] mb-4 text-center">{t("modelSettings.noConfigs")}</p>
                  <button
                    onClick={(e) => {
  ...
  return (
    ...
    >
      <div
        ...
        } transition-opacity duration-300 overflow-y-auto fantasy-scrollbar`}
      >
          ...
          <div className="mb-3 sm:mb-3 mb-2">
            ...
            {!showNewConfigForm && configs.length > 0 && (
              <div className="mb-1.5 sm:mb-1.5 mb-1">
                <p
                  className={`text-xs sm:text-xs text-[10px] italic transition-colors duration-200 ${
                    isConfigHovered ? "text-[#d1a35c]" : "text-[#8a8a8a]"
                  }`}
                >
                  {t("modelSettings.doubleClickToEditName") || "Double-click configuration name to edit"}
                      ...
                      {editingConfigId === config.id ? (
                        ...
                        <>
                          ...
                          {showEditHint && configs.length > 1 && (
                            <span
                              className={`absolute ${
                                idx === 0 ? "top-full mt-1" : "-top-6"
                              } left-0 z-[9999] bg-[#2a2522] text-[#d1a35c] text-[10px] sm:text-[10px] text-[8px] px-2 py-1 sm:px-2 sm:py-1 px-1 py-0.5 rounded border border-[#d1a35c] whitespace-nowrap opacity-0 group-hover/name:opacity-100 transition-all duration-200 pointer-events-none shadow-[0_0_8px_rgba(209,163,92,0.2)]`}
                            >
                              {t("modelSettings.doubleClickToEditName")}
                            </span>
                          )}
              ...
              <div className="relative">
                ...
                >
                  {isTesting ? (
                    ...
                    <>
                      <span className="sm:block hidden">{t("modelSettings.testModel") || "Test Model"}</span>
                      <span className="sm:hidden block">Test</span>
                    </>
                  )}
                </button>
